...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Mar-2021 às 22:36
...
--
CREATE DATABASE IF NOT EXISTS `bd_formulario_sms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
(1, 'bd_formulario_sms', 'tb_acessos_funcionarios', 'funcional', '', '', '', '', '', 'email_funcionario'),
(2, 'bd_formulario_sms', 'tb_acessos_funcionarios', 'email_funcionario', '', '', '', '', '', 'cargo_funcionario');
...
('root', '[{\"db\":\"bd_formulario_sms\",\"table\":\"tb_acessos_funcionarios\"},{\"db\":\"bd_formulario_sms\",\"table\":\"tb_acessos_funcionario\"},{\"db\":\"bd_formulario_sms\",\"table\":\"acessos_funcionarios\"}]');
...
('root', '2021-03-18 21:34:38', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
